...
class Node
{
	 ...
	 */
	public Node(Point pLocation, bool pTrueIfRoom,Room pRoom)
	{
		location = pLocation;
		trueIfRoom = pTrueIfRoom;
		room = pRoom;
    ...
    public Node(Point pLocation, bool pTrueIfRoom, Door pDoor)
    {
        location = pLocation;
        trueIfRoom = pTrueIfRoom;
        door = pDoor;
